                            ...
                            {isDropdownOpen && (
                                ...
                                >
                                    {categories.map((cat, index) => (
                                        <li
                                            key={index}
                                            className={`px-4 py-1 cursor-pointer hover:text-white hover:bg-primaryMedium transition-all capitalize duration-200  ${cat.name === category ? 'bg-primaryMedium text-white' : 'text-secondary'
                                                }`}
                                            onClick={() => {
